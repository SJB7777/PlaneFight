...
public:
	...
	static void Trace(char* message, Args... args)
	{
	...
	{
		get_instance().log("[Cirtical]\t", CriticalPriority, message, args...);
	}
	...
	{
		get_instance().log(line, source_file, "[Cirtical]\t", CriticalPriority, message, args...);
	}
